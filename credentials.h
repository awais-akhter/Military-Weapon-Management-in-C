...
cred creds[] = {
        {"Arslan Jamil","Kendel Jenner"},
        {"Awais Akhter","Jean Grey"},
        {"Sufyan Snake","Secret Knife"}
};
...
void first()
{
    ...
    printf("\n\n");
    blue();
    printf("\t\t\t\t\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb Presenters of this Project \xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb\n");
    red();
    printf("\t\t\t\tLOADING...\n");
    printf("\t\t\t\t\t");
    for (i = 1; i <= 50; i++)
    ...
    printf("\n\t\t\t\t\t\t*******************************************");
    cyan();
    printf("\n\t\t\t\t\t|\t  M. Awais Akhter (FA20-BSE-021) \t|");
    cyan();
    printf("\n\t\t\t\t\t|\t  M. Arslan Jamil (FA20-BSE-002) \t|");
    red();
    printf("\n\t\t\t\t\t\t*******************************************");
    purple();
